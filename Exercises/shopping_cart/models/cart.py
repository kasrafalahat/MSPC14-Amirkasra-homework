...
from typing import List, Dict, Union, Optional, Tuple, Collection
class ShoppingCart:
    ...
    def add_product(self, product_type: str, product_name: str, quantity: Union float =1):
    ...
    def remove_product(self, product_name: str, quantity=1):
